...
class ArtifactEntry(BaseModel):
    ...
    language: str = Field(default="python", description="File language for syntax highlighting.")
...
class RenderPlan(BaseModel):
    ...
    framework_version: str = Field(default="", description="Framework pip specifier.")
